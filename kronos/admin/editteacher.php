...
$getid = $_GET['edit'];
$query = "SELECT * FROM faculty WHERE id = '$getid'";
...
$row = mysqli_fetch_assoc($result);
  ...
  try{
    ...
    if(isset($_POST['signup'])){
       ...
       $result = mysqli_query($con, "update faculty SET fname = '$upfname',lname = '$uplname',username = '$upusername',email = '$upemail',phone = '$upphone' where id = '$id'");
       if($result){
        echo '<script language="javascript">';
