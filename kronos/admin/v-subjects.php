...
<!-- head started -->
<head>
<title>View Subjects | KRONOS </title>
<meta charset="UTF-8">
      ...
      $("#live_search").keyup(function(){
        ...
        if(input != ""){
          $.ajax({
            ...
            url:"../scripts/livesearchsubject.php",
            method:"POST",
            data:{input:input},
...
<div class = "search">
  <div class ="container" style="max-width: 17%;">
          <input type="text" class="form-control" id="live_search" autocomplete="off" placeholder="Search Subject...">
      </div>
</div>
