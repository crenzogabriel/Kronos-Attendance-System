...
$query = "SELECT * FROM students WHERE id = $identity";
  ...
  try{
    ...
    if(isset($_POST['signup'])){
        ...
        $uppass =  $_POST['uppass'];
         ...
         $query = "SELECT username FROM students WHERE username = '$upusername' ";
        $result = mysqli_query($con, $query);
       ...
       $result = mysqli_query($con, "update students SET fname = '$upfname',lname = '$uplname',username = '$upusername',email = '$upemail',phone = '$upphone',pass = '$uppass' where id = '$id'");
       if($result){
        echo '<script language="javascript">';
