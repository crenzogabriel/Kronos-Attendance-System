...
if(isset($_POST['login']))
{
  ...
  $pass = $_POST['pass'];
    ...
    //session_start();
      $numrows=0;
		$result=mysqli_query($con, "select * from faculty where username='$_POST[username]' and pass='$_POST[pass]'");
...
<body>
    ...
    <header class="header">
      ...
      <img class = "logo" src="logo.png" alt="">
        ...
        <button class="button" id="form-open">Faculty Login</button>
      </nav>
    </header>
      ...
      <div class="form_container">
        ...
        <div class="form login_form">
          ...
          <div class = "logo-container">
            ...
            <div class="login_signup">Login as: <a href="index.php">Admin |</a> <a href="studentlogin.php">Student</a></div> 
